...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  "This is a description of Salida"
                  DESC
  ...
  s.source       = { :git => "git@github.com:Neuromobile/salida-pod.git", :tag => "#{s.version}" }
  ...
  # s.library   = "iconv"
    s.libraries = 'c++', 'stdc++'
    s.ios.vendored_frameworks = 'Salida.xcframework'
    s.source_files = "Salida.xcframework/*/Salida.framework/Headers/*.{h,swift}"
